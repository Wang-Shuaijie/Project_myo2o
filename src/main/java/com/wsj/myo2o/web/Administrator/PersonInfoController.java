...
import com.wsj.myo2o.enums.PersonInfoStateEnum;
import com.wsj.myo2o.service.PersonInfoService;
	...
	private Map<String, Object> listPersonInfos(HttpServletRequest request){
		...
		if (pageIndex > 0 && pageSize > 0) {
			...
			if (personInfos.getPersonInfoList() != null) {
				modelMap.put("rows",personInfos.getPersonInfoList());
				modelMap.put("total",personInfos.getCount());
				modelMap.put("success", true);
			} else {
				modelMap.put("rows",new ArrayList<PersonInfo>());
